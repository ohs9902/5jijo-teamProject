...
public class CampManagementApplication {
    static StudentManagement stm = new StudentManagement();
    static  ScoreManagement scm = new ScoreManagement();
    private static Scanner sc = new Scanner(System.in);

    public static void main(String[] args) {

        InitData.setInitData(); //스태틱 메서드 직접 호출
        try {
            displayMainView();
        } catch (Exception e) {
            System.out.println("\n오류 발생!\n프로그램을 종료합니다.");
